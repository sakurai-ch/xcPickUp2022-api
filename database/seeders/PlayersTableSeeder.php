...
class PlayersTableSeeder extends Seeder
{
    public function run()
    {
        $params = [
            ...
            ['no' =>  16, 'name' => '川名 啓', 'glider_type' => 'パラ', 'state' => '自己回収'],
            ...
            ['no' =>  34, 'name' => '砂間 隆司', 'glider_type' => 'ハング', 'state' => '---'],
            ...
            ['no' =>  54, 'name' => '馬場 峻司', 'glider_type' => 'ハング', 'state' => '---'],
            ['no' =>  55, 'name' => '濱田 革', 'glider_type' => 'ハング', 'state' => '---'],
            ['no' =>  56, 'name' => '星合 智子', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  57, 'name' => '星 一彦', 'glider_type' => 'リジット', 'state' => '---'],
            ['no' =>  58, 'name' => '前島 聡夫', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  59, 'name' => '松田 隆至', 'glider_type' => 'リジット', 'state' => '---'],
            ['no' =>  60, 'name' => '松田 隆行', 'glider_type' => 'リジット', 'state' => '自己回収'],
            ['no' =>  61, 'name' => '三竹 涼', 'glider_type' => 'ハング', 'state' => '---'],
            ['no' =>  62, 'name' => '峰岸 正弘', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  63, 'name' => '文字 英彰', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  64, 'name' => '山口 香代', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  65, 'name' => '山口 裕之', 'glider_type' => 'リジット', 'state' => '---'],
            ['no' =>  66, 'name' => '山田 裕一', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  67, 'name' => '山本 剛', 'glider_type' => 'リジット', 'state' => '---'],
            ['no' =>  68, 'name' => '和田 浩二', 'glider_type' => 'パラ', 'state' => '---'],
            ['no' =>  69, 'name' => '渡邊 正剛', 'glider_type' => 'パラ', 'state' => '---'],
        ];
